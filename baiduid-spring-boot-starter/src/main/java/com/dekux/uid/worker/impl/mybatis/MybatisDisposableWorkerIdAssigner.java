 ...
 * @author yutianbao
 */
public class MybatisDisposableWorkerIdAssigner implements WorkerIdAssigner {
    private static final Logger LOGGER = LoggerFactory.getLogger(MybatisDisposableWorkerIdAssigner.class);
